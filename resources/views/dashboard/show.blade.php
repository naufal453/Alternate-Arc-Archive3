                    ...
                    <div class="col">
                        <div class="card h-100 d-flex flex-row align-items-center p-3 position-relative  shadow-sm rounded">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p style="font-size: 0.9em;" class="mb-1 text-muted">{{ Str::limit(strip_tags(html_entity_decode($post->description)), 5) }}</p>
                            ...
                            <div class="ms-3 d-flex flex-column">
                                ...
                                <button class="btn btn-success btn-sm mb-1" type="button" data-bs-toggle="modal" data-bs-target="#chapterListModal{{ $post->id }}">Detail</button>
                            </div>
                            @endif
                        </div>
                    </div>
